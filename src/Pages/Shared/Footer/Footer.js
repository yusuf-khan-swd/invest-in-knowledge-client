...
const Footer = () => {
  ...
  return (
    <div className='bg-slate-800 text-gray-300 dark:bg-gray-800 p-10'>
        ...
        <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
              ...
              <Link className="hover:text-white" to="/">IntelliSense</Link>
            </div>
          </div>
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
              ...
              <Link className="hover:text-white" to="/">Adding Base Styles</Link>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
              ...
              <Link className="hover:text-white" to="/">Spacing</Link>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2 text-sm dark:text-gray-400">
              ...
              <Link className="hover:text-white" to="/">Slack</Link>
              <Link className="hover:text-white" to="/">Facebook</Link>
              <Link className="hover:text-white" to="/">LinkedIn</Link>
            </div>
          </div>
        </div>
        <div className="text-sm bg-gray-600 rounded-xl mt-8 px-8 py-6 text-center">
          <p className="dark:text-gray-400">&copy; Invest In knowledge {copyrightDate}. All Rights Reserved</p>
        </div>
      </footer>
    </div>
  );
